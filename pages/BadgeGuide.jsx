  ...
  return (
    <div className="page">
      ...
      <div className="hero-header" style={{ padding: "18px 16px", marginBottom: 16 }}>
        <div className="hero-name" style={{ fontSize: 22 }}>Badge Guide</div>
        <div style={{ color: "var(--gold)", fontSize: 12.5, position: "relative" }}>Every badge, how to earn it, and what it does.</div>
        <div style={{ display: "flex", gap: 8, marginTop: 12, flexWrap: "wrap", position: "relative" }}>
          <span className="chip badge-attack">Attack</span>
          <span className="chip badge-defense">Defense</span>
          <span className="chip badge-passive">Passive</span>
          <span className="chip badge-tactical">Tactical</span>
        </div>
      </div>
