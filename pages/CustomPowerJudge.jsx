  ...
  return (
    <div className="page">
      ...
      <div className="hero-header" style={{ padding: "18px 16px", marginBottom: 16 }}>
        <div className="hero-name" style={{ fontSize: 22 }}>Custom Power Judge</div>
        <div style={{ color: "var(--purple-bright)", fontSize: 12.5, position: "relative" }}>Test whether a custom ability idea would be fair and balanced.</div>
      </div>
