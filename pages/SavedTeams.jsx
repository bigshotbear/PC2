  ...
  return (
    <div className="page">
      ...
      <div className="hero-header" style={{ padding: "18px 16px", marginBottom: 16 }}>
        <div className="hero-name" style={{ fontSize: 22 }}>Saved Teams</div>
        <div style={{ color: "var(--purple-bright)", fontSize: 12.5, position: "relative" }}>Optional presets for 2v2, 3v3, and 5v5 — never required.</div>
      </div>
