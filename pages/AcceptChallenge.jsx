...
export default function AcceptChallenge({ user, profile, challengeId, onNavigate }) {
  ...
  const idempotencyKeyRef = useRef(getPendingBattle("acceptChallenge:" + challengeId)?.key || null);
  ...
  const handleFight = async () => {
    ...
    if (!idempotencyKeyRef.current) {
      ...
      savePendingBattle("acceptChallenge:" + challengeId, idempotencyKeyRef.current, { note: "friend challenge in progress" });
    }
    ...
    try {
      ...
      clearPendingBattle("acceptChallenge:" + challengeId);
