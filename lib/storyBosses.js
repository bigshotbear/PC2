...
import { ARC3_BOSSES } from "./storyBossesArc3";
import { ARC4_BOSSES } from "./storyBossesArc4";
import { ARC5_BOSSES } from "./storyBossesArc5";
import { ARC6_BOSSES } from "./storyBossesArc6";
...
const ARC1_BOSSES = [
  ...
  },
  {
    ...
    difficultyMult: 1.35,
    stats: { strength: 20, speed: 20, durability: 19, battle_iq: 22, stamina: 17 },
    abilities: [
...
export const STORY_BOSSES = [...ARC1_BOSSES, ...ARC2_BOSSES, ...ARC3_BOSSES, ...ARC4_BOSSES, ...ARC5_BOSSES, ...ARC6_BOSSES];
export const TOTAL_STORY_LEVELS = STORY_BOSSES.length;

export const CHAPTERS = [
  { number: 1, name: "The Streets", levelRange: [1, 7] },
  { number: 2, name: "The Society", levelRange: [8, 17] },
  { number: 3, name: "The Wilds", levelRange: [18, 27] },
  { number: 4, name: "The Circuit", levelRange: [28, 37] },
  { number: 5, name: "The Deep", levelRange: [38, 47] },
  { number: 6, name: "The Convergence", levelRange: [48, 60] }
];
