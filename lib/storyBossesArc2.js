...
export const ARC2_BOSSES = [
  {
    key: "the_puddle_problem", level: 8, chapter: 2, name: "The Puddle Problem",
  ...
  {
    key: "test_dummy_zero", level: 9, chapter: 2, name: "Test Dummy Zero",
  ...
  {
    key: "quiet_guy_with_knives", level: 10, chapter: 2, name: "The Quiet Guy With Knives",
  ...
  {
    key: "protein_shake_enjoyer", level: 11, chapter: 2, name: "The Protein Shake Enjoyer",
  ...
  {
    key: "the_middleman", level: 12, chapter: 2, name: "The Middleman",
  ...
  {
    key: "mister_crumble", level: 13, chapter: 2, name: "Mister Crumble",
  ...
  {
    key: "the_understudy", level: 14, chapter: 2, name: "The Understudy",
  ...
  {
    key: "ceo_of_rage_quitting", level: 15, chapter: 2, name: "The CEO of Rage Quitting",
  ...
  {
    key: "the_awakened_understudy", level: 16, chapter: 2, name: "The Awakened Understudy",
  ...
  {
    key: "the_everything_guy", level: 17, chapter: 2, name: "The Everything Guy",
    ...
    helpsAgainst: "the_overgrown_guy",
    hints: {
